...
public class LevelUpFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.activity_level_up, container, false);
            ...
            ArrayAdapter<String> abilityScoreAdapter1 = new ArrayAdapter<String>(getContext(), android.R.layout.simple_spinner_dropdown_item, abilityScoreList1);
            ArrayAdapter<String> abilityScoreAdapter2 = new ArrayAdapter<String>(getContext(), android.R.layout.simple_spinner_dropdown_item, abilityScoreList2);
            switch (level){
                case 4:
                case 8:
                case 12:
            ...
            finishButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if(moreHP.getText().toString().equals("")){
                        ...
                        Toast.makeText(getContext(), "Make sure you choose 2 different options", Toast.LENGTH_SHORT).show();
                    }else {
                        ...
                        switch(character.getCharacterClass()){
                            ...
                            case "Warlock":
                                ...
                                spellViewModel.loadAllSpells().observe(getViewLifecycleOwner(), new Observer<List<Spell>>() {
                                    @Override
                                    public void onChanged(List<Spell> spells) {
                                        Spell spell = new Spell();
                                        if(finalLevel == 11 || finalLevel == 13 || finalLevel == 17){
                                            for(int i=0; i<spells.size(); i++){
                                                if(spells.get(i).getSpellName().equals(choice1.getSelectedItem().toString())){
                                                    spell = spells.get(i);
                                                    break;
                                                }
                                            }
                                            ...
                                            for(int i=0; i<spells.size(); i++){
                                                if(spells.get(i).getSpellName().equals(choice2.getSelectedItem().toString())){
                                                    spell = spells.get(i);
                                                    break;
                                                }
                                            }
            ...
            switch(character.getCharacterClass()){
                case "Barbarian":
                    switch (level){
                        ...
                        case 3:
                            ...
                            ArrayAdapter<String> totemAdapter = new ArrayAdapter<String>(getContext(),
                        ...
                        case 6:
                            ...
                            switch(character.getSubclass()){
                                ...
                                case "Path of the Totem Warrior":
                                    ...
                                    ArrayAdapter<String> totemPathAdapter = new ArrayAdapter<String>(getContext(),
                ...
                case "Bard":
                    ...
                    ArrayAdapter<String> bardExpertiseAdapter = new ArrayAdapter<String>(getContext(),
                    ...
                    switch (level){
                        ...
                        case 3:
                            if(character.getSubclass().equals("Circle of the Land")){
                                ...
                                ArrayAdapter<String> landCircleAdapter = new ArrayAdapter<String>(getContext(),
                ...
                case "Fighter":
                    ...
                    ArrayAdapter<String> maneuverAdapter = new ArrayAdapter<String>(getContext(),
                        ...
                        case 10:
                            switch(character.getSubclass()){
                                ...
                                case "Champion":
                                    ...
                                    ArrayAdapter<String> fightingStyleAdapter = new ArrayAdapter<String>(getContext(),
                ...
                case "Ranger":
                    ...
                    ArrayAdapter<String> favoredTerrainAdapter = new ArrayAdapter<String>(getContext(),
                            android.R.layout.simple_spinner_dropdown_item, getResources().getStringArray(R.array.favored_terrain_array));
                    ArrayAdapter<String> favoredEnemyAdapter = new ArrayAdapter<String>(getContext(),
                    ...
                    switch (level){
                        ...
                        case 3:
                            switch(character.getSubclass()){
                                case "Hunter":
                                    ArrayAdapter<String> hunterSubclassAdapter = new ArrayAdapter<String>(getContext(),
                ...
                case "Rogue":
                    ...
                    ArrayAdapter<String> rogueExpertiseAdapter = new ArrayAdapter<String>(getContext(),
                ...
                case "Sorcerer":
                    ...
                    ArrayAdapter<String> metamagicAdapter = new ArrayAdapter<String>(getContext(),
                ...
                case "Warlock":
                    ...
                    ArrayAdapter<String> eldritchInvocationsAdapter = new ArrayAdapter<String>(getContext(),
                    ...
                    switch (level){
                        ...
                        case 3:
                            ...
                            ArrayAdapter<String> pactBoonAdapter = new ArrayAdapter<String>(getContext(),
                        ...
                        case 11:
                            ...
                            mysticArcanumAdapter = new ArrayAdapter<String>(getContext(),
                ...
                case "Wizard":
                    ...
                    switch (level){
                        ...
                        case 18:
                            ...
                            signatureSpellAdapter1 = new ArrayAdapter<String>(getContext(),
                                    android.R.layout.simple_spinner_dropdown_item, signatureSpells1);
                            signatureSpells2 = getSpellsPerLevel(2);
                            signatureSpellAdapter2 = new ArrayAdapter<String>(getContext(),
